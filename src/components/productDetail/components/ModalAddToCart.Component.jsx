...
const ModalAddToCartComponent = ({productIndex,singleProduct,count})=>{
	...
	const checkIndex = ()=>{
		if(Number.isInteger(productIndex)){
			return `cartModal${productIndex.toString()}`;
		}
		else{
			return "cartModal";
		}
	...
	return (		
		<>
							<div className="modal fade" id={checkIndex()} tabIndex="-1" aria-labelledby="cartModalLabel" aria-hidden="true">
